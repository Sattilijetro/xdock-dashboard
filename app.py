...
_LOGO_B64 = __import__("base64").b64encode(open(__import__("os").path.join(__import__("os").path.dirname(__file__), "logo.png"), "rb").read()).decode() if __import__("os").path.exists(__import__("os").path.join(__import__("os").path.dirname(__file__), "logo.png")) else ""
